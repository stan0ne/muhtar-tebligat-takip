...
; Bu dosyayı Inno Setup 6.x ile derleyerek setup.exe oluşturun.

#define MyAppName "Muhtar Tebligat Takip"
#define MyAppVersion "1.3.0"
#define MyAppPublisher "Muhtarlık Tebligat Takip Sistemi"
...
PrivilegesRequiredOverridingAllowed=direkt

...
if %errorlevel% neq 0 (
    ...
    copy "build\windows\x64\runner\Release\muhtar_tebligat_takip.msix" "installer\muhtar_tebligat_takip_1.5.12.msix" >nul 2>nul
)
echo.
...
where wix >nul 2>nul
if %errorlevel% equ 0 (
    wix build -o "installer\muhtar_tebligat_takip_setup_1.5.12.msi" -b "%~dp0" -pdb "none" -ext WixToolset.UI.wixext installer.wxs
    if %errorlevel% neq 0 (
...
if exist "installer\muhtar_tebligat_takip_setup_1.5.12.exe" (
...
if exist "installer\muhtar_tebligat_takip_1.5.12.msix" (
    echo   MSIX: installer\muhtar_tebligat_takip_1.5.12.msix
)
if exist "installer\muhtar_tebligat_takip_setup_1.5.12.msi" (
    echo   MSI:  installer\muhtar_tebligat_takip_setup_1.5.12.msi
)
if exist "installer\muhtar_tebligat_takip_setup_1.5.12.exe" (
    echo   EXE:  installer\muhtar_tebligat_takip_setup_1.5.12.exe
)
echo.
pause

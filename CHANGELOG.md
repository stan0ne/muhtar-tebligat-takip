...
- **Windows Installer**: MSIX paketi (modern Windows paketleme formatı). `dart run msix:create` ile tek komutla üretim. Microsoft Store'a yayınlanabilir veya doğrudan dağıtılabilir.
